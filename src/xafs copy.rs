...
pub struct XASGroup {
    ...
    pub ifft_params: Option<IFFTParams>,
...
impl Default for XASGroup {
    fn default() -> Self {
        XASGroup {
            ...
            mu: None,
            e0: None,
            norm_params: Some(NormParams::default()),
            norm: None,
            flat: None,
            bkg_params: Some(BkgParams::default()),
            k: None,
            chi: None,
            chi_kweight: None,
            fft_params: Some(FFTParams::default()),
            chi_r: None,
            chi_r_mag: None,
            chi_r_re: None,
            chi_r_im: None,
            q: None,
            ifft_params: Some(IFFTParams::default()),
        }
    }
}
...
pub struct NormParams {
    pub normalization_method: Option<NormMethod>,
...
impl Default for NormParams {
    fn default() -> Self {
        NormParams {
            normalization_method: Some(NormMethod::default()),
...
impl NormParams {
    pub fn new() -> NormParams {
        NormParams::default()
    }

    pub fn set_normalization_method<T>(&mut self, method: T) {
        todo!();
    }
}
...
#[derive(Debug, Clone, PartialEq)]
pub struct BkgParams {
    pub background_method: Option<BackgroundMethod>,
    pub rbkg: Option<f64>,
...
impl Default for BkgParams {
    fn default() -> Self {
        BkgParams {
            background_method: Some(BackgroundMethod::default()),
            rbkg: Some(1.0),
            nknots: None,
            kmin: Some(0.0),
            kmax: None,
