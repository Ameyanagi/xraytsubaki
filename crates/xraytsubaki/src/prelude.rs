...
pub use crate::xafs::fitting::{
    feffit, feffpath, ff2chi, parse_feff_path_file, path2chi, resolve_feff_commands, run_feff,
    run_feff_and_load_paths, FeffDat, FeffExecutionMode, FeffFitDataset, FeffFitResult,
    FeffFitTransform, FeffFlavor, FeffModuleCommand, FeffPathModel, FeffResolvedCommands,
    FeffRunRequest, FeffRunResult, FitSpace, FitVariable, FitVariables, PathContribution,
    PathParamSpec,
};
