...
use xraytsubaki::xafs::fitting::{FeffFlavor, FeffPathModel, FitVariables, feffpath, path2chi};
...
mod tests {
    ...
    fn feff_diagnostics_use_physical_arrays_and_reference_chi() {
        let file = concat!(
            ...
            "/../xraytsubaki/tests/testfiles/feffcu01.dat"
        );
        ...
        let file = if std::path::Path::new(file).exists() {
            ...
            std::path::PathBuf::from(env!("CARGO_MANIFEST_DIR"))
                .join("../xraytsubaki/tests/testfiles/xraylarch_d867/feffit/feffcu01.dat")
        };
