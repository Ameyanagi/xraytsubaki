...
pub use crate::xafs::fitting::{
    feffit, feffit_batch, feffit_batch_with_options, feffit_multi, feffpath, ff2chi,
    parse_feff_path_file, path2chi, resolve_feff_commands, run_feff, run_feff_and_load_paths,
    DatasetResult, FeffBatchOptions, FeffBatchParallelMode, FeffDat, FeffExecutionMode, FeffFit,
