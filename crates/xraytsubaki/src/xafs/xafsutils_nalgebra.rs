...
fn convolve_valid(signal: &DVector<f64>, kernel: &DVector<f64>) -> Result<DVector<f64>, Box<dyn Error>> {
...
mod tests {
    ...
    fn test_ftwindow_hanning() {
        assert_window_matches("/tests/testfiles/window_Hanning.txt", FTWindow::Hanning, TEST_TOL);
    }

    #[test]
    fn test_ftwindow_parzen() {
        assert_window_matches("/tests/testfiles/window_Parzen.txt", FTWindow::Parzen, TEST_TOL);
    }

    #[test]
    fn test_ftwindow_welch() {
        assert_window_matches("/tests/testfiles/window_Welch.txt", FTWindow::Welch, TEST_TOL);
    }
